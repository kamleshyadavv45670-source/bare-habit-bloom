    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          <h1 className="text-3xl font-semibold tracking-tight mb-2">Habits</h1>
          <p className="text-sm text-muted-foreground">Build better habits, one day at a time</p>
        </div>

        <div className="border border-border rounded-xl p-6 space-y-4">
          <div className="text-center mb-2">
            <p className="text-sm text-muted-foreground">Sign in to save your habits across devices</p>
          </div>
        ...
        <p className="text-center text-xs text-muted-foreground mt-6">
          Your habit data stays private and secure
        </p>
      </div>
    </div>
  );
